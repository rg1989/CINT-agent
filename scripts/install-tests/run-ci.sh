...
utils_tgz="$(find_tarball "$TARBALL_DIR"/cint-utils-*.tgz)"
wire_tgz="$(find_tarball "$TARBALL_DIR"/cint-wire-*.tgz)"
natives_tgz="$(find_tarball "$TARBALL_DIR"/cint-natives-[0-9]*.tgz)"
natives_leaf_tgz="$(find_tarball "$TARBALL_DIR"/cint-natives-"$host_tag"-*.tgz)"
hashline_tgz="$(find_tarball "$TARBALL_DIR"/cint-hashline-*.tgz)"
catalog_tgz="$(find_tarball "$TARBALL_DIR"/cint-catalog-*.tgz)"
ai_tgz="$(find_tarball "$TARBALL_DIR"/cint-ai-*.tgz)"
mnemopi_tgz="$(find_tarball "$TARBALL_DIR"/cint-mnemopi-*.tgz)"
snapcompact_tgz="$(find_tarball "$TARBALL_DIR"/cint-snapcompact-*.tgz)"
agent_tgz="$(find_tarball "$TARBALL_DIR"/cint-agent-core-*.tgz)"
tui_tgz="$(find_tarball "$TARBALL_DIR"/cint-tui-*.tgz)"
stats_tgz="$(find_tarball "$TARBALL_DIR"/cint-stats-*.tgz)"
coding_agent_tgz="$(find_tarball "$TARBALL_DIR"/cint-*.tgz)"
collab_web_tgz="$(find_tarball "$TARBALL_DIR"/cint-collab-web-*.tgz)"
