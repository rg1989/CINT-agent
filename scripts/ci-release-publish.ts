 ...
 *
 * The default mode publishes public JS packages and the `@incrt/cint-natives`
...
export const packages: PublishPackage[] = [
	...
	{ dir: "packages/coding-agent", kind: "typescript", publishBin: { cint: "dist/cli.js" } },
];
...
function buildNativeOptionalDependencies(version: string): JsonObject {
	...
	for (const target of LEAF_TARGETS) {
		optionalDependencies[`@incrt/cint-natives-${target.tag}`] = version;
	}
