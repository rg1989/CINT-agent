 ...
 *
 * Routes through @incrt/cint-ai (`completeSimple`) rather than raw HTTP so model
...
import { completeSimple } from "@incrt/cint-ai";
import type { Api, AssistantMessage, Model } from "@incrt/cint-ai";
import type { GeneratedProvider } from "@incrt/cint-catalog/models";
