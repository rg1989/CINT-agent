---
name: cyber-toctou
description: Time-of-Check / Time-of-Use (TOCTOU) race condition exploitation methodology across binary, kernel, filesystem, web, and container layers. Use when you've identified a 'check then act' pattern and need to widen the race window.
---
