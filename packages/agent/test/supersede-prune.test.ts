...
import type { SessionEntry, SessionMessageEntry } from "@incrt/cint-agent-core/compaction";
import {
...
import type { AssistantMessage, TextContent, ToolResultMessage } from "@incrt/cint-ai";
