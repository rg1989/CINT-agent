...
import { ProviderHttpError } from "@incrt/cint-ai/errors";
import { parseTextSignature } from "@incrt/cint-ai/providers/openai-shared";
import { transformMessages } from "@incrt/cint-ai/providers/transform-messages";
import type { AssistantMessage, FetchImpl, Message, Model } from "@incrt/cint-ai/types";
import {
	getOpenAIResponsesHistoryItems,
	getOpenAIResponsesHistoryPayload,
	normalizeResponsesToolCallId,
} from "@incrt/cint-ai/utils";
import {
	CODEX_BASE_URL,
	getCodexAccountId,
	OPENAI_HEADER_VALUES,
	OPENAI_HEADERS,
} from "@incrt/cint-catalog/wire/codex";
