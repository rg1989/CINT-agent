...
import { type Api, type AssistantMessage, completeSimple, type Model, type Tool } from "@incrt/cint-ai";
import { isTerminalHeadless, logger, prompt } from "@incrt/cint-utils";
