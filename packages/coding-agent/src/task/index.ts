 ...
 *   - ~/.cint/agent/agents/*.md (user-level)
...
import type { AgentTool, AgentToolResult, AgentToolUpdateCallback } from "@incrt/cint-agent-core";
import type { Usage } from "@incrt/cint-ai";
import { $env, logger, prompt, Snowflake } from "@incrt/cint-utils";
