...
import { type ApiKeyResolver, completeSimple } from "@incrt/cint-ai";
import { hostMatchesUrl } from "@incrt/cint-catalog/hosts";
import type { Mnemopi } from "@incrt/cint-mnemopi";
import type * as MnemopiDiagnoseNs from "@incrt/cint-mnemopi/diagnose";
import type { DiagnosticSummary } from "@incrt/cint-mnemopi/diagnose";
...
async function loadMnemopiDiagnose(): Promise<typeof MnemopiDiagnoseNs> {
	if (!mnemopiDiagnoseMod) {
		mnemopiDiagnoseMod = await import("@incrt/cint-mnemopi/diagnose");
	}
