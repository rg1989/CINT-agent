...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@incrt/cint-ai";
...
// Per-provider image-count budgets live in @incrt/cint-snapcompact
