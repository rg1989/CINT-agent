...
} from "@incrt/cint-agent-core/compaction/pruning";
import type { ProtectedToolMatcher } from "@incrt/cint-agent-core/compaction/tool-protection";
import type {
	AssistantMessage,
	ImageContent,
	Message,
