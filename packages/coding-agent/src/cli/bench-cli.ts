import type { ResolvedThinkingLevel } from "@incrt/cint-agent-core";
import type {
	Api,
	ApiKeyResolver,
	AssistantMessage,
...
import { streamSimple } from "@incrt/cint-ai";
import { buildModelProviderPriorityRank, type CanonicalModelVariant } from "@incrt/cint-catalog/identity";
import { replaceTabs, truncateToWidth } from "@incrt/cint-tui";
import { formatDuration, getProjectDir } from "@incrt/cint-utils";
