/**
 * Run CINT — Cyber Intelligence as an ACP (Agent Client Protocol) server over stdio.
 *
 ...
 */
import { Command } from "@incrt/cint-utils/cli";
import { parseArgs } from "../cli/args";
import { runRootCommand } from "../main";
import { prepareAcpTerminalAuthArgs } from "../modes/acp/terminal-auth";

export default class Acp extends Command {
	static description = "Run CINT — Cyber Intelligence as an ACP (Agent Client Protocol) server over stdio";
	static strict = false;
