/**
 * List and clean up agent-managed git worktrees under `~/.cint/wt`.
 */
import { Args, Command, Flags } from "@incrt/cint-utils/cli";
import { clearWorktrees, listWorktrees } from "../cli/worktree-cli";

export default class Worktree extends Command {
	static description = "List or clear agent-managed git worktrees (~/.cint/wt)";
