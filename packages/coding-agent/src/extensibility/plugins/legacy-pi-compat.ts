...
import { isCompiledBinary } from "@incrt/cint-utils";
...
// imports such as `@incrt/cint-ai/oauth` continue to resolve directly
...
// installs where the bundled packages live at `node_modules/@incrt/cint-*`
...
// `@incrt/cint-*` import from the extension's own `node_modules` instead of
