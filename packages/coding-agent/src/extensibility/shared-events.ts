...
import type { CompactionPreparation, CompactionResult } from "@incrt/cint-agent-core/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@incrt/cint-ai";
