 ...
 * primitive in `@incrt/cint-natives`, which infers the language from the file
 ...
 */
import type { BlockResolver } from "@incrt/cint-hashline";
import { blockRangeAt } from "@incrt/cint-natives";
