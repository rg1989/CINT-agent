...
import { PASTE_CODE_LOGIN_PROVIDERS } from "@incrt/cint-ai";
import { getOAuthProviders } from "@incrt/cint-ai/oauth";
import type { OAuthProvider } from "@incrt/cint-ai/oauth/types";
import type { Component, OverlayHandle } from "@incrt/cint-tui";
import { Input, Loader, Spacer, setTuiTight, Text } from "@incrt/cint-tui";
import { getAgentDbPath, getProjectDir, normalizePathForComparison } from "@incrt/cint-utils";
