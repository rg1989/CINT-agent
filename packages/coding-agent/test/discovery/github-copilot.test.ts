...
import { loadCapability, setDisabledProviders } from "@incrt/cint/capability";
import type { ContextFile } from "@incrt/cint/capability/context-file";
import { clearCache } from "@incrt/cint/capability/fs";
import type { Instruction } from "@incrt/cint/capability/instruction";
import type { Prompt } from "@incrt/cint/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@incrt/cint/capability/rule";
import { RuleProtocolHandler } from "@incrt/cint/internal-urls/rule-protocol";
import "@incrt/cint/capability/context-file";
import "@incrt/cint/capability/instruction";
import "@incrt/cint/capability/prompt";
import "@incrt/cint/capability/rule";
