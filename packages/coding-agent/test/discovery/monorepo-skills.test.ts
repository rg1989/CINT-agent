...
import type { LoadContext, LoadResult } from "@incrt/cint-coding-agent/capability/types";
import { scanSkillsFromDir } from "@incrt/cint-coding-agent/discovery/helpers";
