...
import { handleCheatSh } from "@incrt/cint-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@incrt/cint-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@incrt/cint-coding-agent/web/scrapers/tldr";
