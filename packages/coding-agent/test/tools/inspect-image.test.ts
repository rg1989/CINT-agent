...
import { AuthStorage, type completeSimple, type ImageContent, type Model } from "@incrt/cint-ai";
...
import { InspectImageTool } from "@incrt/cint-coding-agent/tools/inspect-image";
import { inspectImageToolRenderer } from "@incrt/cint-coding-agent/tools/inspect-image-renderer";
