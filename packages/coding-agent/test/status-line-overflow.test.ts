...
import type { StatusLineSegmentId } from "@incrt/cint-coding-agent/config/settings-schema";
...
import { getSessionAccentAnsi, getSessionAccentHex } from "@incrt/cint-coding-agent/utils/session-color";
