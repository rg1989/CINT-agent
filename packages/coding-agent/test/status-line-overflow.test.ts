...
import type { StatusLineSegmentId } from "@incrt/cint/config/settings-schema";
...
import { getSessionAccentAnsi, getSessionAccentHex } from "@incrt/cint/utils/session-color";
