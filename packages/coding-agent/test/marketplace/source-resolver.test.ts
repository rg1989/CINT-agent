...
import type { MarketplacePluginEntry } from "@incrt/cint-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@incrt/cint-coding-agent/extensibility/plugins/marketplace";
