import type { Effort } from "@incrt/cint-catalog/effort";
import { toFirepassWireModelId, toFireworksWireModelId } from "@incrt/cint-catalog/fireworks-model-id";
import { isGlm52ReasoningEffortModelId } from "@incrt/cint-catalog/identity";
import { getSupportedEfforts } from "@incrt/cint-catalog/model-thinking";
import { calculateCost } from "@incrt/cint-catalog/models";
import type {
	OpenAICompat,
...
} from "@incrt/cint-catalog/types";
import { parseGitHubCopilotApiKey } from "@incrt/cint-catalog/wire/github-copilot";
import { $env, extractHttpStatusFromError, logger, structuredCloneJSON } from "@incrt/cint-utils";
import {
	type Api,
