...
import { isOfficialAnthropicApiUrl } from "@incrt/cint-catalog/compat/anthropic";
import { buildOpenAICompat, buildOpenAIResponsesCompat } from "@incrt/cint-catalog/compat/openai";
...
import { openrouterModelManagerOptions } from "@incrt/cint-catalog/provider-models/openai-compat";
