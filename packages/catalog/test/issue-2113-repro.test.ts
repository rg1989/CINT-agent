...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "@incrt/cint-ai/providers/openai-completions";
import type { AssistantMessage, Context } from "@incrt/cint-ai/types";
...
import { moonshotModelManagerOptions } from "@incrt/cint-catalog/provider-models/openai-compat";
import type { Model, ModelSpec } from "@incrt/cint-catalog/types";
