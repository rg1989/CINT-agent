...
} from "@incrt/cint-catalog/discovery/antigravity";
import { Effort } from "@incrt/cint-catalog/effort";
import { stripThinkingVariantToken } from "@incrt/cint-catalog/identity/family";
import { resolveProviderModels } from "@incrt/cint-catalog/model-manager";
import { resolveWireModelId } from "@incrt/cint-catalog/model-thinking";
import { googleGeminiCliModelManagerOptions } from "@incrt/cint-catalog/provider-models/google";
import type { ModelSpec } from "@incrt/cint-catalog/types";
import {
